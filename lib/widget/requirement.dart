  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: <Widget>[
        ...
        getRequirementItems(context: context, text: 'Soap', imgSrc: 'soap', bgColor: Colors.orange[300], imgColor: Colors.grey[700]),
      ],
    );
  }
}
...
Widget getRequirementItems({BuildContext context, String text, String imgSrc, Color bgColor, Color imgColor}) {
  return Column(
    children: <Widget>[
      ...
      Text(text, style: Theme.of(context).textTheme.subtitle.apply(color:Colors.red),)
    ],
  );
}
